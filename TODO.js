...
const printTodoItem = (text) => {
  ...
  const todoIteml = document.createElement("li");
  const todoItems = document.createElement("span");
  const todoItemb = document.createElement("button");
...
const printDoneItem = (text) => {
  ...
  btn.addEventListener("click", deleteDoneItem);
  ...
  document.querySelector(".done-list").appendChild(todoItem);
